...
\employer{Facebook}{Menlo Park, CA (remote)}{Software Engineering Intern}{June 2020 --- August 2020}
	\begin{achievements}
	\item Designed and implemented framework in \texttt{Relay} and \texttt{Hack/PHP}, resulting in a dynamically rendered feed and simplified \texttt{GraphQL} queries. Integrated this structure cross-platform to unify Facebook desktop with mobile.
